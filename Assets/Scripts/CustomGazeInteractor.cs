...
namespace DefaultNamespace
{
    public class CustomGazeInteractor : MonoBehaviour
    {
        ...
        private bool _canRemoveGizmos;

        public static event Action<RaycastHit> OnMarkerHit;
        ...
        private void RaycastClosestHit(InputAction.CallbackContext ctx) {
            ...
            if (Physics.Raycast(_mainCamera.transform.position, _mainCamera.transform.forward,
                ...
                if (hit.transform.tag.Equals("Marker") && _canRemoveGizmos)
                {
                    OnMarkerHit?.Invoke(hit);
                }
        ...
        public void CanRemoveGizmos(bool canRemove)
        {
            _canRemoveGizmos = canRemove;
        }
